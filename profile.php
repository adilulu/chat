...
function post_date_latest_sort($post1, $post2) {
    $post1_date = $post1->get_property('post_date');
    $post2_date = $post2->get_property('post_date');

    if ($post1_date === $post2_date) {
        return 0;
    }

    return ($post1_date > $post2_date) ? -1 : 1;
}
...
<head>
    ...
    <title>TNTS Study Hub - <?php echo $fetched_user->getPropertyValue("username"); ?></title>
        ...
        <section id="second-section">
            <div id="second-part-left-panel">
                ...
                <div class="user-info-section">
                    ...
                    <p class="regular-text" style="margin: 10px 0; color: #f5f8fa"><?php echo $bio; ?></p>
                    <p class="calendar-icon regular-text-style-2" style="color: #f5f8fa">Member since <?php echo date("F Y", strtotime($fetched_user->getPropertyValue("joined"))) ?></p>
