            ...
            if(empty($friends)) {
                echo <<<EMPTY
                    <div class="flex-column" style="margin-top: 40px">
                        <img src="public/assets/images/icons/search.png" alt="" style="height: 40px; width: 40px; margin: 0 auto;">
                        <p style="text-align: center">Try to add your friends and schoolmates ..</p>
