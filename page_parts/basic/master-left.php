    ...
    <div>
        <div>
            ...
            <div id="master-left-container">
                ...
                <a href="flashcards-master/index.html" class="no-underline menu-item-style-2 row-v-flex">
                    <div class="image-style-2 flex-row-column">
                        <img src="public/assets/images/icons/messages.png" class="image-style-5" alt="">
                    </div>
                    <p class="label-style-3">Flashcards</p>
                </a>
                ...
                <div id="menu-profile-container" class="relative">
                    ...
                    <div class="header-profile-name-container">
                        <a href="<?php echo $user_profile_path; ?>" class="no-underline"><h1 style="color: #f5f8fa" class="header-profile-fullname"><?php echo $user->getPropertyValue("firstname") . " " . $user->getPropertyValue("lastname"); ?></h1></a>
